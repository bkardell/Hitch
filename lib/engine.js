var Hitch = (function(){
	...
	var 
		...
		matchesSelector = (function(){
			...
			if(head.matchesSelector){ vendor = ""; matches = 'matchesSelector'; }
				...
				return function(e,sel){
					...
					return toArray(document.getElementsByTagName('body')[0].querySelectorAll(sel)).indexOf(e) !== -1;
				};
			}
		...
		query = function(el,q){ if(typeof HITCH_TESTS !== "undefined"){ q = q.replace(/:not(.*)/,'');} 
