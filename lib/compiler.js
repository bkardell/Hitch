var cssPluginsCompiler = function(src, finished){
	...
	// shim for trim in unsupporting browsers
	...
	$.when.apply($,pluginSources).then(function(pluginSource){
		...
		for(var i = 0; i < input.length; i++){
			//TODO: Do we need to create the regex on every rule? (save the heap)
...
if(typeof module !== 'undefined' && module.exports){
	module.exports.cssPluginsCompiler = cssPluginsCompiler;
}
