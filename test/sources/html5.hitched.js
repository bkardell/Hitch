...
Hitch.selectors.register(["h1:--math-lessthan(data-x,2)","h2:--math-lessthan(data-x,10)","ul:--math-lessthan(data-x,10) li","p:--math-lessthan(data-score,1000)","p .foo:--math-lessthan(data-score,1000)[bar]","p .foo :--math-lessthan(data-score,1000)[bar]","p .foo:--math-lessthan(data-score,1000) [bar]","#content :--math-greaterthan(data-score,1000)"]);
Hitch.observe();