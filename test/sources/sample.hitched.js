...
Hitch.selectors.register(["p:--math-lessthan(data-score,1000)","p .foo:--math-lessthan(data-score,1000)[bar]","p .foo :--math-lessthan(data-score,1000)[bar]","p .foo:--math-lessthan(data-score,1000) [bar]","#content :--math-greaterthan(data-score,1000)"]);
Hitch.observe();